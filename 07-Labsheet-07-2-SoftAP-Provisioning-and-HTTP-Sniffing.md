...
| **5. IP Address ที่ ESP32 ได้รับจาก Router** | 172.20.10.4 |
| **6. เวลาที่ใช้ตั้งแต่เริ่มจนจบกระบวนการ (วินาที)** | 44วิ. |

---

## 7. คำถามท้ายการทดลอง (Post-Lab Questions)
1. ในโหมด SoftAP Scheme สมาร์ตโฟนส่งข้อมูลหา ESP32 ผ่านโปรโตคอลและ IP Address ใด?
สื่อสารผ่านโปรโตคอล HTTP ส่งไป IP Address เริ่มต้นของบอร์ด ESP32 192.168.4.1
...
Event WIFI_PROV_CRED_FAIL ESP32 จะส่งสถานะล้มเหลวกลับไปแจ้งแอปมือถือ จะไม่ปิดตัวเอง แต่จะยังเปิดโหมด Provisioning ทิ้งไว้ เพื่อรอให้ผู้ใช้ส่งรหัสผ่านชุดใหม่เข้ามาแก้ไข
3. ทำไมผู้ผลิต IoT ส่วนใหญ่จึงมองว่ากระบวนการเชื่อมต่อแบบ SoftAP มีขั้นตอนที่ยุ่งยากสำหรับผู้ใช้ทั่วไปเมื่อเทียบกับ BLE?
SoftAP บังคับให้ผู้ใช้สลับเครือข่าย Wi-Fiต้องกดยกเลิก Wi-Fi บ้าน แล้วไปต่อ Wi-Fi ของตัวอุปกรณ์ ซึ่งสมาร์ตโฟนจะเตือนว่าเครือข่ายไม่มีอินเทอร์เน็ต ต่างจากแบบ BLE ที่แอปคุยกับอุปกรณ์ผ่านบลูทูธได้แบบเบื้องหลัง โดยที่สมาร์ตโฟนของผู้ใช้ไม่ต้องตัดเน็ตบ้าน
