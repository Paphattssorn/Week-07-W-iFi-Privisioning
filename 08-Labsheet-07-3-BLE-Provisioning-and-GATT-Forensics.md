...
```
<img width="1200" height="339" alt="ผังงานการตัดสินใจ2" src="https://github.com/user-attachments/assets/d822146b-b927-426f-b433-1aba5c996c96" />
<img width="995" height="1085" alt="ผังงานการตัดสินใจ4" src="https://github.com/user-attachments/assets/fa4c5909-6f85-45ad-90cb-02b5d0f633a5" />
...
| :--- | :--- |
| **1. BLE Device Name ที่สแกนเจอ** | `PROV_0E0248` |
| **2. Primary Service UUID (128-bit)** | {"ver":"v1","name":"PROV_0E0248","pop":"abcd1234","transport":"ble"} |
...
| **5. พฤติกรรมเมื่อต่อ Wi-Fi สำเร็จ** | มี Log คืนหน่วยความจำ Bluetooth หรือไม่?  มี BTDM memory released |

---

## 7. คำถามท้ายการทดลอง (Post-Lab Questions)
1. เหตุใด BLE Provisioning จึงไม่ส่งผลให้สัญญาณ Wi-Fi บนสมาร์ตโฟนของผู้ใช้หลุดระหว่างทำรายการ?
Bluetooth กับ Wi-Fi บนมือถือทำงานแยกกัน การต่อ BLE ไม่ต้องบังคับให้มือถือสลับเครือข่ายเน็ตเหมือนแบบ SoftAP
2. Descriptor `0x2901` มีความสำคัญอย่างไรต่อการที่แอปพลิเคชันมือถือจะทราบว่า Characteristic แต่ละตัวใช้ทำหน้าที่อะไร?
ใช้เก็บข้อความอธิบาย เช่น ชื่อ Endpoint custom-data แอปมือถืออ่านและรู้ได้ทันทีว่าช่องทางนี้ใช้ทำอะไร โดยที่ไม่ต้องฝังรหัส UUID ไว้ในแอป
3. การที่ ESP-IDF มีฟังก์ชัน `esp_bt_mem_release()` มีประโยชน์อย่างไรต่อการทำงานของแอปพลิเคชัน IoT หลังเชื่อมต่อ Wi-Fi สำเร็จ?
ใช้เพื่อปิด Bluetooth ถาวรและ คืนพื้นที่ RAM กลับให้ระบบ ทำให้บอร์ดมีหน่วยความจำเหลือไปทำงานอื่นต่อไป
